...
def walk_Right(period,gait):
    ...
    # set_Legs( \
    #     {"ForeLeft":  np.array([ lean-25, -trans["ForeLeft"],  elevate["ForeLeft"]]), \
    #      "BackLeft":  np.array([ lean-15, trans["BackLeft"],  elevate["BackLeft"]]), \
    #      "ForeRight": np.array([ lean-25, -trans["ForeRight"], elevate["ForeRight"]]), \
    #      "BackRight": np.array([ lean-15, trans["BackRight"], elevate["BackRight"]]) \
    #      })

    set_Legs( \
        {"ForeLeft":  np.array([ lean, -trans["ForeLeft"]-20,  elevate["ForeLeft"]]), \
         "BackLeft":  np.array([ lean, trans["BackLeft"]+10,  elevate["BackLeft"]]), \
         "ForeRight": np.array([ lean, -trans["ForeRight"]+20, elevate["ForeRight"]]), \
         "BackRight": np.array([ lean, trans["BackRight"]-10, elevate["BackRight"]]) \
         })
